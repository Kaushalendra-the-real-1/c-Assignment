...
namespace Q2TwoFileLinq
{
    class Program
    {
        class StudentDetails
        {
            ...
            {
                string studentDetailsCsvFile = @"D:\C#\Q2TwoFileLinq\Q2TwoFileLinq\studentDetails.csv";
                string studentBillStatementCsvFile = @"D:\C#\Q2TwoFileLinq\Q2TwoFileLinq\billStatement.csv";
