...
namespace Q3CSVLinq
{
    class Program
    {
        class StudentDetails
        {
            ...
            {
                string studentDetails = @"D:\C#\Q3CSVLinq\Q3CSVLinq\studentDetails.csv";
                string studentBusFee = @"D:\C#\Q3CSVLinq\Q3CSVLinq\busFee.csv";
                string driverDetails = @"D:\C#\Q3CSVLinq\Q3CSVLinq\driverDetails.csv";
